...
async function getCovidData() {
    ...
    InfoBx = `<div class="card" style="width: 14rem;">
                 ...
                 <h4 class="card-title" style="color:red"> +${jsData.cases_time_series[556].dailyconfirmed}</h4>
               ...
               <h4 class="card-title" style="color:green"> +${jsData.cases_time_series[556].dailyrecovered}</h4>
               ...
               <h4 class="card-title" style="color:red"> +${jsData.cases_time_series[556].dailydeceased}</h4>
